...
class WSKafkaConnector extends EventEmitter {
    ...
    createConsumerGroup(ws, topics, msg){
        ...
        ws.consumer.subscribed_topics, ws.consumer.response_msg.payload = topics;
        ...
        ws.consumer
            ...
            .on('message', function onKafkaMsg(data) {
                try {
...
//                    ws.consumer.commit(WSKafkaConnector.edCallback);
    ...
    createConsumer(ws, client, payload, msg) {
        ...
        ws.consumer.subscribed_topics = payload;
        ws.consumer.response_msg = Msg.createReplyMessage(msg);
